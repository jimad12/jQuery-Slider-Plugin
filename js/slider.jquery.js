(function($) {
  $.fn.slider = function(options) {
    //Add Animations delay
    var defaults = {
      duration: 1000,
      animationDelay: 5000
    };
    //initial varibles set up we will to methods'call
    ...
    return this.each(function() {
      ...
      //Determine button's click to slide along the next image
      var $index = $(".index");
      ...
      //Animate the slider, move it farward 
      var animateSlider = function(direction, callback) {
        $sliderList.stop(true, true).animate({
          ...
          //using margin for direction back or forward direction
          ...
          var resetTimer = function() {
                ...
                //Find button clicks for back or forward events
          ...
          //Set up for using the keyboard and events for left and right arrow press downward
